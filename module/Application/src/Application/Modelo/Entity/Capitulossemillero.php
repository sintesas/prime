...
class Capitulossemillero extends TableGateway{
	...
	public function __construct(Adapter $adapter = null, $databaseSchema =null, ResultSet $selectResultPrototype =null){
		return parent::__construct('msi_capitulosemillero', $adapter, $databaseSchema, $selectResultPrototype);
	}
	...
	public function addCapitulosemillero($data=array(), $id, $archi){
    ...
    public function getCapitulosemillero($id){
    ...
    public function getCapitulot(){
   	...
   	public function eliminarCapitulosemillero($id) {
        		$this->delete(array('id' => $id));
    }

    public function getCapitulosemilleroById($id)
    {
    ...
    public function updateCapitulosemillero($id, $data = array())
    {   
        $array = array(
            'titulo' => $data->titulo,
    ...
    public function updatearchivoCapitulosemillero($id, $archi)
    {   
        $array = array(
            'archivo' => $archi
        );
