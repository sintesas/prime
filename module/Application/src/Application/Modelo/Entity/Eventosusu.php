...
class Eventosusu extends TableGateway{
	
	//funcion constructor
	public function __construct(Adapter $adapter = null, $databaseSchema =null, ResultSet $selectResultPrototype =null){
		return parent::__construct('aps_eventosusu', $adapter, $databaseSchema, $selectResultPrototype);
	}
   
	public function addEventosusu($data=array(), $id, $archi){
		$array=array(
			'id_red'=>$id,
  		...
  		$this->insert($array);
		return $this->getAdapter()->getDriver()->getConnection()->getLastGeneratedValue("aps_eventosusu_id_evento_seq");
	}

    public function getEventosusu($id){
		$resultSet = $this->select(array('id_red'=>$id));
		return $resultSet->toArray();
   	}

    public function getEventosusut(){
		$resultSet = $this->select();
		return $resultSet->toArray();
   	}

   	public function eliminarEventosusu($id) {
        $this->delete(array('id_evento' => $id));
    }

    public function getEventosusuById($id)
    {
    ...
    public function updateEventosusu($id, $data = array())
    {   
        $array = array(
            'id_tipoevento'=>$data->id_tipoevento,
            'id_tipoparticipacion'=>$data->id_tipoparticipacion,
    ...
    public function updatearchivoEventosusu($id, $archi)
    {   
        $array = array(
            'archivo' => $archi
        );
