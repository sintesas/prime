...
class Eventosgru extends TableGateway{
	
	//funcion constructor
	public function __construct(Adapter $adapter = null, $databaseSchema =null, ResultSet $selectResultPrototype =null){
		return parent::__construct('mgi_eventosgru', $adapter, $databaseSchema, $selectResultPrototype);
	}
   
	public function addEventosgru($data=array(), $id, $archi){
		$array=array(
			'id_red'=>$id,
  		...
  		$this->insert($array);
		return $this->getAdapter()->getDriver()->getConnection()->getLastGeneratedValue("mgi_eventosgru_id_evento_seq");
	}

    public function getEventosgru($id){
		$resultSet = $this->select(array('id_red'=>$id));
		return $resultSet->toArray();
   	}

    public function getEventosgrut(){
		$resultSet = $this->select();
		return $resultSet->toArray();
   	}

   	public function eliminarEventosgru($id) {
        $this->delete(array('id_evento' => $id));
    }

    public function getEventosgruById($id)
    {
    ...
    public function updateEventosgru($id, $data = array())
    {   
        $array = array(
            'id_tipoevento'=>$data->id_tipoevento,
            'id_tipoparticipacion'=>$data->id_tipoparticipacion,
    ...
    public function updatearchivoEventosgru($id, $archi)
    {   
        $array = array(
            'archivo' => $archi
        );
