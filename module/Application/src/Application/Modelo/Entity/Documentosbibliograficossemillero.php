...
class Documentosbibliograficossemillero extends TableGateway
{
    ...
    {
        return parent::__construct('msi_documentosbibliograficos', $adapter, $databaseSchema, $selectResultPrototype);
    }

    private function cargaAtributos($datos = array(), $id)
    {
        $this->id_semillero = $id;
    ...
    public function addDocumentosbibliograficossemillero($data, $id, $archi)
    {
    ...
    public function getDocumentosbibliograficossemilleroid($id)
    {
    ...
    public function getDocumentosbibliograficossemillerot()
    {
    ...
    public function eliminarDocumentosbibliograficossemillero($id)
    {
        $this->delete(array(
            'id' => $id
        ));
    ...
    public function getBibliograficossemilleroById($id)
    {
        $resultSet = $this->select(array(
            'id' => $id
        ));
    ...
    public function updateBibliograficossemillero($id, $data = array())
    {   
        $array = array(
            'nombre' => $data->nombre,
    ...
    public function updatearchivoBibliograficossemillero($id, $archi)
    {   
        $array = array(
            'archivo' => $archi
        );
