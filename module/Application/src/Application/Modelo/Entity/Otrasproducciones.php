...
class Otrasproducciones extends TableGateway{
	...
	public function __construct(Adapter $adapter = null, 
				...
				ResultSet $selectResultPrototype =null){
					return parent::__construct('mgi_gi_otra_prod', 
								$adapter, 
								$databaseSchema,
	...
	public function addOtrasproducciones($data=array(), $id, $archi){
    ...
    public function getOtrasproduccionesh($id){
		$resultSet = $this->select(array('id_otra_prod'=>$id));
		return $resultSet->toArray();
   	}

    public function getOtrasproducciones($id){
		$resultSet = $this->select(array('id_grupo_inv'=>$id));
		return $resultSet->toArray();
   	}

   	public function getOtrasproduccionest(){
		$resultSet = $this->select();
		return $resultSet->toArray();
   	}

   	public function eliminarOtrasproducciones($id) {
    	$this->delete(array('id_otra_prod' => $id));
    }

    public function getOtrasproduccionesById($id)
    {
    ...
    public function updateOtrasproducciones($id, $data = array())
    {   
        $array = array(
    ...
    public function updatearchivoOtrasproducciones($id, $archi)
    {   
        $array = array(
            'archivo' => $archi
        );
