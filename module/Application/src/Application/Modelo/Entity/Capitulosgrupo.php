...
class Capitulosgrupo extends TableGateway{
	...
	public function __construct(Adapter $adapter = null, $databaseSchema =null, ResultSet $selectResultPrototype =null){
		return parent::__construct('mgi_capitulosgrupo', $adapter, $databaseSchema, $selectResultPrototype);
	}
	...
	public function addCapitulogrupo($data=array(), $id, $archi){
    ...
    public function getCapitulogrupo($id){
    ...
    public function getCapitulot(){
   	...
   	public function eliminarCapitulogrupo($id) {
    ...
    public function updatearchivoCapitulo($id, $archi)
    {   
        $array = array(
            'archivo' => $archi
        );
