...
class Trabajogradogru extends TableGateway{
	
	//funcion constructor
	public function __construct(Adapter $adapter = null, $databaseSchema =null, ResultSet $selectResultPrototype =null){
		return parent::__construct('mgi_trabajogradogru', $adapter, $databaseSchema, $selectResultPrototype);
	}
   
	public function addTrabajogradogru($data=array(), $id, $archi){
		...
		$array=array(
  		...
  		$this->insert($array);
		return $this->getAdapter()->getDriver()->getConnection()->getLastGeneratedValue("mgi_trabajogradogru_id_trabajogrado_seq");
	}

    public function getTrabajogradogru($id){
		$resultSet = $this->select(array('id_red'=>$id));
		return $resultSet->toArray();
   	}

    public function getTrabajogradogrut(){
		$resultSet = $this->select();
		return $resultSet->toArray();
   	}

   	public function eliminarTrabajogradogru($id) {
        $this->delete(array('id_trabajogrado' => $id));
    }

    public function getTrabajogradogruById($id)
    {
    ...
    public function updateTrabajogradogru($id, $data = array())
    {   
        $idDependenciaAcademica = "";
        $idProgramaAcademico = "";
        if ($data["id_dependencia"] != '') {
    ...
    public function updatearchivoTrabajogradogru($id, $archi)
    {   
        $array = array(
            'archivo' => $archi
        );
