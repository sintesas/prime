...
use Application\Solicitudes\SolcambioequipoForm;
...
class SolcambioequipoController extends AbstractActionController
{
	private $auth;
	public $dbAdapter;
    ...
    public function indexAction()
    {
        ...
        $SolcambioequipoForm = new SolcambioequipoForm();
		//verificar roles
		$per=array('id_rol'=>'');
		$dat=array('id_rol'=>'');
		...
		if(true){
		$view = new ViewModel(array('form'=>$SolcambioequipoForm,
									'titulo'=>"Solicitud de cambio de equipo",
									'menu'=>$dat["id_rol"]));
		return $view;
		}
		else
