...
use Application\Solicitudes\SolcancelacionForm;
...
class SolcancelacionController extends AbstractActionController
{
	private $auth;
	public $dbAdapter;
    ...
    public function indexAction()
    {
        ...
        $SolcancelacionForm = new SolcancelacionForm();
		//verificar roles
		$per=array('id_rol'=>'');
		$dat=array('id_rol'=>'');
		...
		if(true){
		$view = new ViewModel(array('form'=>$SolcancelacionForm,
									'titulo'=>"Solicitud cancelación y/o prorroga de monitores",
									'menu'=>$dat["id_rol"]));
		return $view;
		}
		else
