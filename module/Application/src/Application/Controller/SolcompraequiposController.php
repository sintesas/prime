...
use Application\Solicitudes\SolcompraequiposForm;
...
class SolcompraequiposController extends AbstractActionController
{
	private $auth;
	public $dbAdapter;
    ...
    public function indexAction()
    {
        ...
        $SolcompraequiposForm = new SolcompraequiposForm();
		//verificar roles
		$per=array('id_rol'=>'');
		$dat=array('id_rol'=>'');
		...
		if(true){
		$view = new ViewModel(array('form'=>$SolcompraequiposForm,
									'titulo'=>"Solicitud de Compra de equipos",
									'menu'=>$dat["id_rol"]));
		return $view;
		}
		else
