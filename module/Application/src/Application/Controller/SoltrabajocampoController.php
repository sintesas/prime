...
use Application\Solicitudes\SoltrabajocampoForm;
...
class SoltrabajocampoController extends AbstractActionController
{
	private $auth;
	public $dbAdapter;
    ...
    public function indexAction()
    {
        ...
        $SoltrabajocampoForm = new SoltrabajocampoForm();
		...
		if(true){
		$view = new ViewModel(array('form'=>$SoltrabajocampoForm,
									'titulo'=>"Solicitud de trabajo de campo",
									'menu'=>$dat["id_rol"]));
		return $view;
		}
		else
