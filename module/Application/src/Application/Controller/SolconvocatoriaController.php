...
class SolconvocatoriaController extends AbstractActionController
{
	private $auth;
	public $dbAdapter;
    ...
    public function indexAction()
    {
        ...
        $SolconvocatoriaForm = new SolconvocatoriaForm();
		//verificar roles
		$per=array('id_rol'=>'');
		$dat=array('id_rol'=>'');
		...
		if(true){
		$view = new ViewModel(array('form'=>$SolconvocatoriaForm,
									'titulo'=>"Solicitar permiso para aplicar a una convocatoria de forma extemporánea",
									'menu'=>$dat["id_rol"]));
		return $view;
		}
		else
