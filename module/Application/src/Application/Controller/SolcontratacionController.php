...
use Application\Solicitudes\SolcontratacionForm;
...
class SolcontratacionController extends AbstractActionController
{
	private $auth;
	public $dbAdapter;
    ...
    public function indexAction()
    {
        ...
        $SolcontratacionForm = new SolcontratacionForm();
		//verificar roles
		$per=array('id_rol'=>'');
		$dat=array('id_rol'=>'');
		...
		if(true){
		$view = new ViewModel(array('form'=>$SolcontratacionForm,
									'titulo'=>"Solicitud de contratación de personal",
									'menu'=>$dat["id_rol"]));
		return $view;
		}
		else
