...
use Application\Solicitudes\SolsocializacionForm;
...
class SolsocializacionController extends AbstractActionController
{
	private $auth;
	public $dbAdapter;
    ...
    public function indexAction()
    {
        ...
        return $this->redirect()->toUrl($this->getRequest()->getBaseUrl().'/application/login/index');
			...
			//print_r($data);
			$u->addSolsocializacion($data,$identi->usuario);
			//exit;
        ...
        $SolsocializacionForm = new SolsocializacionForm();
		//verificar roles
		$per=array('id_rol'=>'');
		$dat=array('id_rol'=>'');
		...
		if(true){
		$view = new ViewModel(array('form'=>$SolsocializacionForm,
									'titulo'=>"Solicitud de socialización",
									'menu'=>$dat["id_rol"]));
		return $view;
		}
		else
