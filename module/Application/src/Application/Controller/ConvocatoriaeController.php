...
use Application\Convocatoria\ConvocatoriaeForm;
...
class ConvocatoriaeController extends AbstractActionController
{
	private $auth;
	public $dbAdapter;
    ...
    public function indexAction()
    {
		...
		if($this->getRequest()->isPost()){
			...
			$ConvocatoriaeForm = new ConvocatoriaeForm();
			//adiciona la noticia
			$id = (int) $this->params()->fromRoute('id',0);
			$resultado=$not->addConvocatoria($data,'e');
			...
			if ($resultado!=null){
                ...
                $evento = 'Creacion de convocatoria externa : ' . $resultado;
		...
		else
		{
			...
			$id = (int) $this->params()->fromRoute('id',0);
			$view = new ViewModel(array('form'=>$ConvocatoriaeForm,
										'titulo'=>"Convocatoria Externa",
