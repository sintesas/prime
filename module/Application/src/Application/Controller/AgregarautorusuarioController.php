...
use Application\Editarusuario\AgregarautorusuarioForm;
...
class AgregarautorusuarioController extends AbstractActionController
{
	private $auth;
	public $dbAdapter;
    ...
    public function indexAction()
    {
		...
		$AgregarautorusuarioForm = new AgregarautorusuarioForm();
		...
		$u = new Agregarautorusuario($this->dbAdapter);
	...
	public function eliminarAction(){
		...
		$u->eliminarAgregarautorusuario($id);
		$this->flashMessenger()->addMessage("Producción de investigación eliminada con éxito.");
		return $this->redirect()->toUrl($this->getRequest()->getBaseUrl().'/application/editarusuario/index/'.$id3);	
	}
	...
	public function addAction(){
		...
		$u->addAgregarautorusuario($id,$id2,$id3,$id4);
	...
	public function dropAction(){
		...
		$id3 = (int) $this->params()->fromRoute('id3',0);
		$id4 = (int) $this->params()->fromRoute('id4',0);
		$u->eliminarAgregarautorusuario($id,$id2,$id3,$id4);
