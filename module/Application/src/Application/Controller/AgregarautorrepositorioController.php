...
use Application\Repositorio\AgregarautorrepositorioForm;
...
class AgregarautorrepositorioController extends AbstractActionController
{
	private $auth;
	public $dbAdapter;
    ...
    public function indexAction()
    {
		...
		$AgregarautorrepositorioForm = new AgregarautorrepositorioForm();
		$this->dbAdapter=$this->getServiceLocator()->get('db1');
		...
		$u = new Agregarautorrepositorio($this->dbAdapter);
		...
		if(true){
			...
			$view = new ViewModel(
				array(
					'form'=>$AgregarautorrepositorioForm,
	...
	public function eliminarAction(){
		...
		$u->eliminarAgregarautorrepositorio($id);
	...
	public function addAction(){
		...
		$u->addAgregarautorrepositorio($id,$id2,$id3,$id4);
	...
	public function dropAction(){
		...
		$id3 = (int) $this->params()->fromRoute('id3',0);
		$id4 = (int) $this->params()->fromRoute('id4',0);
		$u->eliminarAgregarautorrepositorio($id,$id3,$id2,$id4);
