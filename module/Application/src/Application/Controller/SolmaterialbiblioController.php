...
use Application\Solicitudes\SolmaterialbiblioForm;
...
class SolmaterialbiblioController extends AbstractActionController
{
	private $auth;
	public $dbAdapter;
    ...
    public function indexAction()
    {
        ...
        $SolmaterialbiblioForm = new SolmaterialbiblioForm();
		//verificar roles
		$per=array('id_rol'=>'');
		$dat=array('id_rol'=>'');
		...
		if(true){
		$view = new ViewModel(array('form'=>$SolmaterialbiblioForm,
									'titulo'=>"Solicitud de material bibliográfico",
									'menu'=>$dat["id_rol"]));
		return $view;
		}
		else
