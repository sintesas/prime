...
use Application\Editarredinv\AgregarautorredForm;
...
class AgregarautorredController extends AbstractActionController
{
	private $auth;
	public $dbAdapter;
    ...
    public function indexAction()
    {
		...
		$usuariosArray = array();
		$AgregarautorredForm = new AgregarautorredForm();
		$this->dbAdapter=$this->getServiceLocator()->get('db1');
		...
		$u = new Agregarautorred($this->dbAdapter);
		...
		if( $id3 == 6){
			$titulo = "Agregar/Quitar Integrante equipo de trabajo";
		}else{
	...
	public function addAction(){
		...
		$u->addAgregarautorred($id,$id2,$id3,$id4);
	...
	public function dropAction(){
		...
		$id3 = (int) $this->params()->fromRoute('id3',0);
		$id4 = (int) $this->params()->fromRoute('id4',0);
		$u->eliminarAgregarautorred($id,$id3,$id2,$id4);
