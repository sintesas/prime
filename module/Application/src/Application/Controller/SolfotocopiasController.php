...
use Application\Solicitudes\SolfotocopiasForm;
...
class SolfotocopiasController extends AbstractActionController
{
	private $auth;
	public $dbAdapter;
    ...
    public function indexAction()
    {
        ...
        $SolfotocopiasForm = new SolfotocopiasForm();
		//verificar roles
		$per=array('id_rol'=>'');
		$dat=array('id_rol'=>'');
		...
		if(true){
		$view = new ViewModel(array('form'=>$SolfotocopiasForm,
									'titulo'=>"Solicitud de servicio de fotocopiado",
									'menu'=>$dat["id_rol"]));
		return $view;
		}
		else
