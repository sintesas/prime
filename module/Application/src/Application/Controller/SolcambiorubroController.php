...
use Application\Solicitudes\SolcambiorubroForm;
...
class SolcambiorubroController extends AbstractActionController
{
	private $auth;
	public $dbAdapter;
    ...
    public function indexAction()
    {
        ...
        $SolcambiorubroForm = new SolcambiorubroForm();
		//verificar roles
		$per=array('id_rol'=>'');
		$dat=array('id_rol'=>'');
		...
		if(true){
		$view = new ViewModel(array('form'=>$SolcambiorubroForm,
									'titulo'=>"Solicitud de cambio de rubro",
									'menu'=>$dat["id_rol"]));
		return $view;
		}
		else
